...
#if defined(BY25D20)
#define BY25DXX_DEV_ID 0x11
#elif defined(BY25D40)
...
#if defined(BY25D20)
    BY25DXX_PROTECT_248KB = 0x01U,
    BY25DXX_PROTECT_240KB = 0x02U,
    BY25DXX_PROTECT_224KB = 0x03U,
    BY25DXX_PROTECT_192KB = 0x04U,
    BY25DXX_PROTECT_128KB = 0x05U,
    BY25DXX_PROTECT_256KB = 0x07U
#elif defined(BY25D40)
